...
const FoodCard = ({item}) => {
  ...
  <div className="relative inline-block">
      <div className="absolute top-0 right-0 w-1/4 h-1/6 bg-black bg-opacity-70 rounded-md  flex justify-centers items-center text-white text-center font-bold">${price}</div>
      <figure>
